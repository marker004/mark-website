...
export default function map() {
  const copy = {
    ...
    body: [
      ...
      `I quickly discovered that there are limitations to how many points one can plot in a single Google My Map, so this project was born.
      ...
      I eventually ended up hosting those files in github and loading them from there, and the intermittent errors stopped happening.`,
    ],
  };
  ...
  return (
    <>
      <section>
        <h1 className="text-2xl mb-3">{"Dad's Bike Trip"}</h1>
